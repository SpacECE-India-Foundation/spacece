	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<h4>An Image Post</h4>
					<p><img class="img-responsive" src="assets/img/blog01.jpg" alt="" style="height:150px; width:200px;">
					<p>Lorem Ipsum is simply  ok a galley of type and scrambled it to make a type specimen book.</p>
					<p><a href="blog01.php">Continue Reading...</a></p>
				</div>
