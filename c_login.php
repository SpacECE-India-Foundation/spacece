...
if (isset($_POST['submit'])) {
    ...
    $sq = "SELECT  `user_name` FROM `user_details` WHERE `user_name` ='$user_name'";
    ...
    if (mysqli_num_rows($r) != 0) {
        ...
        $sql = "INSERT INTO `user_details`(`user_name`, `fullname`, `user_email`, `user_mobile`, `user_password`, `user_img`, `user_type`, `user_address`, `created_at`) VALUES ('$user_name','$fullname','$user_email','$user_mobile','$user_password','$filename','$user_type','$user_address',CURRENT_TIMESTAMP)";
        ...
        if ($res) {
            echo "insert done";
               header('Location: c_consultd.php' . "?user=$user_name&email=$user_email&mob=$user_mobile&address=$user_address");
    ...
    elseif($user_type =="admin" ){
        ...
        if ($res) {
            echo "insert done";
               header('Location: c_index.html' . "?user=$user_name");
...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 text-lg-right header-top-right">
                        ...
                        <div>
                            <br><a href="logoutg.php" style="color:orange;"><i class="fa fa-user-circle-o" style="color:black;"></i><b>LOGOUT</b></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <form id="form" method="post" action="c_login.php" enctype="multipart/form-data">
...
top: 120px; left:calc(49% - 50px);"></img></center><br><br><br><br>
            ...
            <tr>
                ...
                <td><input type="text" name="fullname" size="30" value="<?php echo $f ?>">
                    <br><br>
                </td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="user_email" size="300" value="<?php echo $e ?>">
                    <br><br>
                </td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="user_phone" size="30" placeholder="Phone no">
                    <br><br>
                </td>
            </tr>
            <td>
            ...
            <td><input type="text" name="user_password" size="30" placeholder="Password">
                <br><br>
            </td>
            </tr>
            <tr>
                <td>
                    <font size=5>ADDRESS:<span style="color:red;font-weight:bold">*</span></font>
                </td>
                <td><input type="text" name="user_address" size="300" placeholder="Enter address">
                    <br><br>
                </td>
            </tr>
