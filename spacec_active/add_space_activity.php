    ...
    <main>
      <div class="form-card">
        ...
        <form id="activityForm" action="add_activity.php" method="POST" novalidate></form>
          ...
          <!-- 
          Bug Fix Note:
          Previously, the status field was showing a validation error even for valid inputs like "Completed" or "Ongoing".
          Reason: The 'pattern' attribute was case-sensitive and only accepted lowercase values (scheduled, ongoing, completed).
          Fix: Updated the regex pattern to accept both uppercase and lowercase variations for each valid value.Now the field accepts Scheduled, scheduled, Ongoing, ongoing, Completed, or completed -->
          <input type="text" id="status" name="status" 
                placeholder=" " 
                required
                pattern="[Ss]cheduled|[Oo]ngoing|[Cc]ompleted">
          <div class="error-message empty-message">Please fill out this field.</div>
