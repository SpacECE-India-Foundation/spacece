...
<div class="container ">
    ...
    <!-- <form id="activityForm" action="save_space_activity.php" method="POST" novalidate> -->
        <!-- Bug ID : SWP-UI-014
        Issue:
        The <form> tag in add_space_activity.php was incorrectly self-closed.
        As a result, all input fields and the submit button were placed outside the form element.

        Impact:
        - Form submission was not working.
        - Validation script was not triggering correctly.
        - Activity data was not being sent to add_activity.php.
        - Page functionality was broken.

        Fix Applied:
        - Removed the incorrectly self-closed <form> tag.
        - Properly wrapped all input fields and the submit button inside the <form> element.
        - Ensured correct opening and closing structure of the form.
        - Verified JavaScript validation works correctly after fix.

        Result:
        - Form now submits successfully.
        - Validation works as expected.
        - Data is correctly posted to add_activity.php. -->
        <form id="activityForm" action="add_activity.php" method="POST" novalidate></form>
