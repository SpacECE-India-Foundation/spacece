...
<button onclick="window.open('www.instamojo.com/@spacece/l3a3b190992504d639f4fb6fc9bfc40fe/', '_self')" type="button" class=" btn btn-md btn-round d-flex justify-content-center " style="background-color:orange; margin-bottom:25px;" ><h6>Subscribe</h6></button>
