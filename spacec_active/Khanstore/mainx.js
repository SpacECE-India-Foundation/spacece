$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == "login_success") {
                    ...
                    window.location.href = "Khanstore/cart.php";
                } else {
                    $("#e_msg").html(data);
                    $(".overlay").hide();
                }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data == "register_success") {
                    window.location.href = "Khanstore/index.php";
                } else {
    ...
    /*
          ...
          and send it to /Khanstore/action to perform product removal operation
      */
    ...
    /*
          ...
          and send it to /Khanstore/action to perform product qty updation operation
    ...
    /*
          ...
          First it will enable php isset($_POST["Common"]) in /Khanstore/action page and inside that
