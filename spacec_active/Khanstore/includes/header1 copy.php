...
<div class="Navbar">
   <div class="Navbar__Link Navbar__Link-brand">
     ...
     <a href="http://educationfoundation.space/spacece/c_index.html" class="col-sm-1" > <img src="../space.jpg " class=" d-flex img-fluid" style=""  alt=""  /></a> 
  ...
  <nav class="Navbar__Items mt-3">
    <div class="Navbar__Link ">
            <strong><a href="<?= BASE_URL; ?>" style="color: black"><i class="fa fa-home"></i>Home</a>strong>
               
    </div>
    
    <div class="Navbar__Link">
       <strong><a href="<?= BASE_URL; ?>courses" style="color: black"><i class="fa fa-envelope"></i>COURSES </a></strong>
    </div>
    <div class="Navbar__Link">
     <strong><i class="fa fa-users"></i> ABOUT US</a></strong>
    </div>
    <div>
    <?php
                $page='space_active';
     ...
     <div class="row">
            <div >
                ...
                <a href="https://www.facebook.com/SpacECEIn"
                  ><i class="fa fa-facebook  px-1 ml-5"></i
                ></a>
                <a href="https://www.instagram.com/spacece.in/"
                  ><i class="fa fa-instagram px-1 ml-5"></i
                ></a>
                <a href="https://t.me/joinchat/EtMJq_3BKL4zNGE1"
                  ><i class="fa fa-telegram px-1 ml-5" aria-hidden="true"></i
                ></a>
                <a href="https://www.linkedin.com/company/spacece-co/"
                  ><i class="fa fa-linkedin px-1 ml-5"></i
                ></a>
                        ...
                        if(isset($_SESSION['u_id'])){
                             $url = BASE_URL; 
                              ?>
                                ...
                                ?>
                                <a href='login.php' class="text-dark"> <i class="fa fa-user-circle-o" style="color: black"></i> Login</a>
                           <?php
                            }
                        ?>
               </i> </a>  
