...
$sql = "INSERT INTO `consultant`( `name`, `category`, `office`, `mobile`, `ctime`, `pass`, `lno`, `stime`, `email`,`fees`) VALUES ('$user_name','$category','$office','$phone','$ctime','$pass','$lno','$stime','$email','$fees')";
...
<form id="form" method="post" action="c_consultd.php" >
...
<td><input type="text" name="username" size="300" value="<?php echo $f ?>">
<br><br>
</td>
</tr>
<tr>
...
<td><input type="text" name="office"  size="300" value="<?php echo $of ?>">
  <br><br>
</td>
</tr>
<tr>
<td><font size=5>PHONE NO<span style="color:red;font-weight:bold">*</span></font></td>
<td><input type="text" name="phone"  size="30" value="<?php echo $m ?>">
  <br><br>
</td>
</tr>
<td><font size=5>EMAIL<span style="color:red;font-weight:bold">*</span></font></td>
<td><input type="text" name="email"  size="30" value="<?php echo $e ?>">
  <br><br>
</td>
</tr>
<td><font size=5>FEES<span style="color:red;font-weight:bold">*</span></font></td>
<td><input type="text" name="fees"  size="30" placeholder="enter fees">
  <br><br>
</td>
</tr>
