  ...
  <section class="blog-section spad" style="text-align: center;">
    <div class="container">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-4">
          <div class="card h-100">
            <div class="card-img-top" style="height: 150px;"> <a href="milestone/Parent_Dashboard.php">
                <img src="img/logo/Milestone_tracker_logo.png" alt="CHILLDRENS PROFILE" width="150" height="150" /></a>
              <h5><a href="#"> </a></h5>
            </div>
            <div class="card-body text-start card-hover-orange">
              <h5 class="card-title" style="font-weight:bold;font-size:x-large;"> Milestone Tracker</h5>
              <p class="card-text">
                Track, understand, and support your child's early development journey with care and clarity.
              </p>
            </div>
          </div>
        </div>
