...
<body>
        ...
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body text-start card-hover-orange">
              ...
              <p class="card-text">
                Lib For Smalls is a web-based tool that allows guardians to book appointments with childcare experts such as pediatricians, child psychologists, nutritionists, etc.
              </p>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript" src="js/bootstrap.min.js"></script>
    ...
    <!-- Add Footer section to make email submission in newsletter successfully.  -->
