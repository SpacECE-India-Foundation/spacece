    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="./includes/img/banner/LearnOnApp.png" alt="First slide" style="width: 100%; height: 30%" />
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src=".includes/img/banner/LibForSmalls.jpeg" alt="Second slide" />
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src=".includes/img/banner/SpacActive.jpeg" alt="Third slide" />
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src=".includes/img/banner/SpacTube.jpeg" alt="Fourth slide" />
        </div>
      </div>
