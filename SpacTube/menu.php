...
<ul class="nav justify-content-center bg-dark" >
                ...
                <button onclick="window.open('https:/www.spacece.co/about-us', '_self')" name = "about" class="btn-btn"style="background-color:orange;"><h6>About Us</h6></button>

                <button onclick="window.open('http:/api.whatsapp.com/send?phone=+919096305648')" name = "contact" class="btn-btn"style="background-color:orange;"><h6>Contact Us</h6></button>
