...
//No search and no filter → show default paginated results
} else {
    // Default (pagination)
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body pt-2 pb-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-2">
                                            <!-- Like Button -->
                                            <div>
                                              <button name="like" class="btn p-0">
                                                <i class="fas fa-thumbs-up" style="color:blue; font-size: 1.2rem;"></i>
                                              </button>
                                              <span><?php echo $video_data['like_count']; ?></span>
                                            </div>

                                            <!-- Dislike Button -->
                                            <div>
                                              <button name="dislike" class="btn p-0">
                                                <i class="fas fa-thumbs-down" style="color:red; font-size: 1.2rem;"></i>
                                              </button>
                                              <span><?php echo $video_data['dislike_count']; ?></span>
                                            </div>
                                            ...
                                            <div class="share-wrap">
                                              ...
                                              <div class="networks-5">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.youtube.com/watch?v=<?php echo $video_data['v_url']; ?>" target="_blank" class="fa fa-facebook-f"></a>
                                                <a href="https://twitter.com/intent/tweet?url=https://www.youtube.com/watch?v=<?php echo $video_data['v_url']; ?>" target="_blank" class="fa fa-twitter"></a>
                                                <a href="https://www.linkedin.com/shareArticle?url=https://www.youtube.com/watch?v=<?php echo $video_data['v_url']; ?>" target="_blank" class="fa fa-linkedin"></a>
                                                <a href="whatsapp://send?text=Watch this: https://www.youtube.com/watch?v=<?php echo $video_data['v_url']; ?>" target="_blank" class="fa fa-whatsapp" data-action="share/whatsapp/share"></a>
                                              </div>
                                            </div>
                                        </div>
                                    </div>
  ...
  <script>
    $(document).ready(function() {
      $('#sub').on('submit', function(e) {
        ...
        $.ajax({
          method: "POST",
          url: "./common/function.php",   // 👈 this calls your PHP file
          data: {
            subscribe: 1,
            email: email
          },
          success: function(data) {
            ...
            alert("Server said: " + data);  // temporary debug
            handleSubscriptionResponse(data);
          },
          error: function(xhr, status, error) {
            swal("Error!", "Something went wrong. Please try again later.", "error");
      ...
      function handleSubscriptionResponse(data) {
        switch (data.trim()) {
          case 'Already':
            swal("Oops!", "You are already subscribed!", "warning");
            break;
          case 'Success':
            swal("Success!", "You have been subscribed!", "success");
            break;
          case 'MailError':
            swal("Note!", "Subscribed, but confirmation email not sent.", "info");
            break;
          case 'DBError':
            swal("Error!", "Database insert failed!", "error");
            break;
          default:
            swal("Error!", "Unexpected response: " + data, "error");
        }
      }
    });
  </script>
