...
.search-input {
  padding: 10px 40px 10px 20px;  /* Enough padding for icon */
  border-radius: 30px;
...
.filter-row {
  ...
  margin-bottom: 20px;
  position: relative;
  z-index: 999; /* 🔥 important: bring it to front */
}
...
<div id="course-cards" class="cards-container">
  ...
  <div class="card"><img src="img2.png" alt="Infant Care"><h6>Infant Care</h6><p>Care techniques and safety practices.</p><strong>Certificate <i class="bi bi-award"></i></strong><p class="small-text">Get a completion certificate</p></div>
  <div class="card"><img src="img3.png" alt="Infant Care"><h6>Infant Care</h6><p>Handling sleep routines and hygiene.</p><strong>Certificate <i class="bi bi-award"></i></strong><p class="small-text">Get a completion certificate</p></div>
  <div class="card"><img src="img1.png" alt="Infant Care"><h6>Infant Care</h6><p>Feeding techniques & tips.</p><strong>Certificate <i class="bi bi-award"></i></strong><p class="small-text">Get a completion certificate</p></div>
  <div class="card"><img src="img2.png" alt="Infant Care"><h6>Infant Care</h6><p>Comfort & emotional bonding.</p><strong>Certificate <i class="bi bi-award"></i></strong><p class="small-text">Get a completion certificate</p></div>
  <div class="card"><img src="img3.png" alt="Infant Care"><h6>Infant Care</h6><p>Understand developmental cues.</p><strong>Certificate <i class="bi bi-award"></i></strong><p class="small-text">Get a completion certificate</p></div>
  <div class="card"><img src="img1.png" alt="Infant Care"><h6>Infant Care</h6><p>Common challenges & solutions.</p><strong>Certificate <i class="bi bi-award"></i></strong><p class="small-text">Get a completion certificate</p></div>
  <div class="card"><img src="img2.png" alt="Infant Care"><h6>Infant Care</h6><p>Routine creation and discipline.</p><strong>Certificate <i class="bi bi-award"></i></strong><p class="small-text">Get a completion certificate</p></div>
  <div class="card"><img src="img3.png" alt="Infant Care"><h6>Infant Care</h6><p>Baby massage and bath safety.</p><strong>Certificate <i class="bi bi-award"></i></strong><p class="small-text">Get a completion certificate</p></div>
</div>
