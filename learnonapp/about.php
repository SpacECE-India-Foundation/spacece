...
<div class="main-section hero-banner-bg">
    ...
    <!-- <a href="enrollment.php"><button class="btn btn-primary-custom" onclick="location.href='../cits/enrollment.php'">Enroll for Free</button></a> -->
         <a><button class="btn btn-primary-custom" onclick="location.href='../cits/enrollment.php'">Enroll for Free</button></a>
    <div class="tag-box">
      <div class="tag">Top Instructors</div>
      <!-- <div class="tag">New Skills</div> -->
      <div class="tag" id="newSkillsBtn">New Skills</div>
    </div>

    <!-- Hidden Skills Section -->
    <div id="skillsSection" style="display:none; margin-top:20px;">
      <ul style="list-style-type: disc; padding-left: 40px; color: #333;">
        <li>Feeding and Burping Techniques</li>
        <li>Safe Sleep Practices</li>
        <li>Recognizing Baby Cues</li>
        <li>Basic First Aid for Infants</li>
      </ul>
    </div>
  ...
  <div class="video-pagination">
    ...
    <button id="prevPage"><i class="bi bi-chevron-left"></i></button>
 ...
 <section class="testimonial-section">
  ...
  <script>
    ...
    document.getElementById("newSkillsBtn").addEventListener("click", function() {
  ...
  <script>
  let currentPage = 1;
  let totalPages = 100; // backend se dynamic bhi kar sakte ho
  ...
  function updatePagination() {
      ...
      console.log("Load videos for page:", currentPage);
      // Yaha AJAX se videos fetch karna ho to code add karo
  }
  </script>
