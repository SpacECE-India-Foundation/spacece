    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>2025-02-20</td>
          <td>SPECE101</td>
          <td><label style="display: flex; align-items: center; gap: 4px;">Completed <input type="checkbox" name="checkbox1" value="completed"/></label></td>
          <td><label style="display: flex; align-items: center; gap: 4px;">Pending <input type="checkbox" name="checkbox1" value="Pending"/></label></td>
          <td><button onclick="redirectToPediatrician()">Book Pediatrician</button></td>
          <script>
            function redirectToPediatrician() {
