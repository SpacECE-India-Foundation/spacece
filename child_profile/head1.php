...
<body class="hold-transition login-page">
  ...
  <a style="font-size: 15pt;color: black;" href="cits/healthofficer/index.php"><i class="fa fa-sign-in"></i> Clerk</a>
...
<b><i>CHILD IMMUNIZATION TRACKING  SYSTEM<br>SECURE AND ACCURATE IMMUNIZATION INFORMATION MANAGEMENT!<br>using computerized databases that record all immunization doses administered  to children.</i></b>
</marquee>
<style>
