...
.add-btn {
  ...
  cursor: pointer;
  display: inline-block;
  width: fit-content;          /* sirf content ke hisaab se */
  margin: 0 auto;
}
...
<form action="weight.php" method="post" class="data-form">
  ...
  <div class="form-group">
    ...
    <input type="text" id="current_age" name="current_age" placeholder="Your entry here">
  </div>

  <div class="form-group">
    <label for="current_height">Current Height</label>
    <input type="text" id="current_height" name="current_height" placeholder="Your entry here">
  </div>

  <div class="form-group">
    <label for="current_weight">Current Weight</label>
    <input type="text" id="current_weight" name="current_weight" placeholder="Your entry here">
  </div>
