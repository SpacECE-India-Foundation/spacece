						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select doctors.docName as docname,appointment.*  from appointment join doctors on doctors.id=appointment.docId where appointment.userId='".$_SESSION['id']."'");
$cnt=1;
