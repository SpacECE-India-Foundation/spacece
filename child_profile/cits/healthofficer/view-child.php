...
<html lang="en">
	<head>
		<title>Doctor | Manage Child Info</title>
...
<div class="row">
<div class="col-sm-8">
<h1 style="color: red; padding-left: 570px" class="mainTitle">Doctor | Manage Child Info</h1>
</div>
...
<p align="center">                            
 <button style="background-color: green" class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Add Immunization Details</button></p>  
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <th>Vaccine ID :</th>
    <td>
    <input name="br" placeholder="Vaccine ID" class="form-control wd-450" required="true"></td>
  </tr>                          
     <tr>
    <th>Vaccine Name :</th>
    <td>
