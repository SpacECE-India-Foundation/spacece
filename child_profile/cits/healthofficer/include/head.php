...
<div class="w3-bar w3-border w3-black">
  <a href="dashboard.php" class="w3-bar-item w3-button">Health Officer Dashboard</a>
 ...
 <a style="float:right;" href="change-password.php" class="w3-bar-item w3-button w3-hover-none w3-text-white w3-hover-text-white"><i class="fa fa-key"></i> Change Password</a>
  <a style="float:right;" href="edit-profile.php" class="w3-bar-item w3-button w3-hover-none w3-text-white w3-hover-text-white"><i class="fa fa-user"></i> <?php $query=mysqli_query($con,"select docName from doctors where id='".$_SESSION['id']."'");
