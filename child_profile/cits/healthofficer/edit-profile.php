...
if (isset($_POST['submit'])) {
	...
	$email = $_POST['email'];
	$sql = mysqli_query($con, "Update doctors set specialization='$specialization',docName='$name',address='$address',docFees='$docfees',contactno='$contactno' where id='" . $_SESSION['id'] . "'");
	if ($sql) {
