...
<html lang="en">
	<head>
		<title>Parent Users | View Immunization History</title>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">View <span class="text-bold">Immunization History</span></h5>
...
$sql=mysqli_query($con,"select tblchildren.* from tblchildren join users on users.email=tblchildren.ParentEmail where users.id='$uid'");
$cnt=1;
...
<a href="view-immhistory.php?viewid=<?php echo $row['ID'];?>"><i class="fa fa-eye"></i></a>
