...
<html lang="en">
	<head>
		<title>Admin | View Child Immunization info</title>
...
<div class="row">
<div class="col-sm-8">
<h1 style="padding-left: 510px; color: red;" class="mainTitle">Admin  | View  Immunization Details</h1>
</div>
...
<div class="row">
<div class="col-md-12">
<h1 style="padding-left: 500px; color: white;" class="mainTitle">Between Dates | Report Details</h1>
<?php
...
$sql=mysqli_query($con,"select * from tblchildren where date(CreationDate) between '$fdate' and '$tdate'");
$cnt=1;
