...
{
$docspecialization=$_POST['docspecilization'];
$sql=mysqli_query($con,"update  docSpecilization set specilization='$docspecialization' where id='$id'");
													...
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
															<label for="exampleInputEmail1">
																Edit Veterinary Specialization
															</label>

	<?php 

$id=intval($_GET['id']);
	$sql=mysqli_query($con,"select * from docSpecilization where id='$id'");
while($row=mysqli_fetch_array($sql))
{														
	?>		<input type="text" name="docspecilization" class="form-control" value="<?php echo $row['specilization'];?>" >
	<?php } ?>
														</div>
