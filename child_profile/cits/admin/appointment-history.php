...
<html lang="en">
	<head>
		<title>Parent | Appointment History</title>
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select doctors.docName as docname,users.fullName as pname,appointment.*  from appointment join doctors on doctors.id=appointment.docId join users on users.id=appointment.userId ");
$cnt=1;
