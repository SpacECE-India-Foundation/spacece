...
<html lang="en">
	<head>
		<title>Doctor | Manage Child</title>
...
<div class="row">
<div class="col-sm-8">
<h1 style="padding-left: 400px; color: red;" class="mainTitle">Admin  | View Child Immunization Record</h1>
</div>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Children</span></h5>
<?php
                               $vid=$_GET['viewid'];
...
<td colspan="4" style="font-size:20px;color:blue">
 Child Immunization Details</td></tr>
  ...
  <tr>
    ...
    <td><?php  echo $row['childImmu'];?></td>
     <th>Childe Registration Date</th>
