...
//         formData.append('c_categories', $('#c_categories').val());
// formData.append('c_office', $('#c_office').val());
// formData.append('c_from_time', $('#c_from_time').val());
// formData.append('c_to_time', $('#c_to_time').val());
// formData.append('c_language', $('#c_language').val());
// formData.append('c_fee', $('#c_fee').val());
// formData.append('c_available_days', $('#c_available_days').val());
// formData.append('c_qualification', $('#c_qualification').val());
//         // $.ajax({
...
$(document).ready(function(){
    ...
    formData.append('c_fee', $('#c_fee').val());
    formData.append('c_qualification', $('#c_qualification').val());
    var days = $('#c_available_days').val();
    formData.append('selectedItem', days ? days.join(',') : '');
}
