...
CREATE TABLE `cust_products` (
  ...
  `product_name` varchar(250) CHARACTER SET utf8 ,
  `product_cat` varchar(250) CHARACTER SET utf8 ,
  `product_brand` varchar(250) CHARACTER SET utf8 ,
  `product_des` varchar(250) CHARACTER SET utf8 ,
  `product_image` varchar(250) CHARACTER SET utf8,
