...
<?php
  ...
  ?>
<a href="./cdetails.php?category=all" class="btn btn-secondary">View All consultants</a><a href="./cdetails.php?category=all" class="btn btn-secondary">View All consultants</a>
