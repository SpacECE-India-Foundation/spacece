...
if($u_id || $c_id && $status==='Active' ){
   ...
   //echo "inside2";
    ...
    if($u_id){
        $sql="SELECT DISTINCT spaceece.users.u_name as u_id,spaceece.users.u_name as c_name,spaceece.users.u_image as c_image,consultant_app.new_apointment.booking_id,
