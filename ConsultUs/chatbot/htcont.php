...
$sql = "SELECT * FROM `msg` WHERE `room`='$room' ORDER BY rtime ASC";
...
if ($isCurrentUser) {
    ...
    $avatarSrc = $avatarFallback;
            ...
            if (!$isCurrentUser) echo "<img class='avatar' src='$avatarSrc' onerror=\"this.src='$avatarFallback'\" alt='User'>";
            echo "
            <div class='bubble'>
        ...
        ";
            if ($isCurrentUser) echo "<img class='avatar' src='$avatarSrc' onerror=\"this.onerror=null;this.src='$avatarFallback';\" alt='You'>";
            echo "</div>";
        }
    } else {
