				...
				<div >
					<div >
						...
						<ul class="main-menu" style="margin-left: 60px;">
							...
							<li><a href="contact.html" style="color:black;"><i class="fa fa-envelope" style="color:black;"></i> FEEDBACK</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<!-- ChatBot -->
<div class="chat_icon">
	<i class="fa fa-comments" aria-hidden="true" style="color:black;border: 1px solid black;"></i>
</div>
