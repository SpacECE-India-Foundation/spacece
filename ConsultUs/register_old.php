...
<tr>
<td><input type="reset" value="Reset" style="background-color:orange;"></td>
<td><center><input type="submit" value="Register" name="submit" style="background-color:orange;"></center>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 footer-widget">
					<div class="contact-widget">
						...
						<p><i class="fa fa-map-marker" style="color:black"></i><a href="http://www.spacece.in/" style="color:black"> SPACE-ECE</a></p>
						<p style="color:black"><i class="fa fa-phone" style="color:black"></i>+91 90963 05648</p>
						<p style="color:black"><i class="fa fa-envelope" style="color:black"></i><a href="mailto:events@spacece.co" target="_blank" rel="noopener">contactus@spacece.co</a></p>
