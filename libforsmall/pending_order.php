...
$_SESSION['delivery_boy_id']=45;
$sql = "SELECT * from orders where order_status='Accepted' AND p_status!='Delivered' AND delivery_boy_id=''";
    $res = $conn->query($sql);
    ...
    while($row=mysqli_fetch_assoc($res)){
         ?>
          <tr>
            ...
            <td><input type="button" id="<?php echo $row['order_id']; ?>" name="edit" value="pic order" class="btn btn-sm btn-primary edit"> </td>
        </tr>
         <?php }
