...
$baseQuery = " FROM products p 
        ...
        WHERE c.cat_title = 'Academics' AND p.user_id = ? AND p.product_title LIKE ?";
...
<body class="academics-page">
  ...
  <nav class="nav-bar">
    <div class="nav-left">
      ...
      <a href="Academics.php">
        <button class="nav-button active">Academics</button></a>
      <a href="Popular.php">
  ...
  <main>
    ...
    <div class="pagination-wrapper">
      <div class="pagination">
        <?php if ($page > 1): ?>
          <a class="page-btn" href="Academics.php?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>&filter=<?php echo $filter; ?>"><i class="fas fa-chevron-left"></i></a>
        <?php endif; ?>

        <span class="page-info">Page <?php echo $page; ?> of <?php echo $totalPages; ?></span>

        <?php if ($page < $totalPages): ?>
          <a class="page-btn" href="Academics.php?page=<?php echo $page + 1; ?>&search=<?php echo urlencode($search); ?>&filter=<?php echo $filter; ?>"><i class="fas fa-chevron-right"></i></a>
        <?php endif; ?>
      </div>
    </div>
  ...
  <style>
    .academics-page .navbar .logo img {
      width: 75px;
      height: auto;
      max-height: 75px;
      object-fit: contain;
            ...
            .then(data => {
              if (data.status === 'success') {
                ...
                if (confirm('Product added to cart. Do you want to continue shopping? Press OK for Yes, Cancel for No.')) {
                  ...
                  // Cancel => redirect to academics
                  window.location.href = 'Academics.php';
                }
              } else {
