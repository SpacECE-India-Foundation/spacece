    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="add-product-form" enctype="multipart/form-data">
            ...
            <div class="col-12">
        			<div class="form-group">
		        		<label>Perday Rent</label>
		        		<input type="number" name="rent_price" class="form-control" placeholder="Enter Product Price">
		        	</div>
        		</div>
            ...
            <div class="col-12">
        			<div class="form-group">
		        		<label>Deposit</label>
		        		<input type="number" name="deposit" class="form-control" placeholder="Enter Product Price">
		        	</div>
        		</div>
