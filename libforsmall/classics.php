...
$baseQuery = " FROM products p 
        ...
        WHERE c.cat_title = 'Classics' AND p.user_id = ? AND p.product_title LIKE ?";
...
<body class="classics-page">
  <nav class="nav-bar">
    <div class="nav-left">
      ...
      <a href="classics.php">
        <button class="nav-button active">Classics</button></a>
  ...
  <main>
    ...
    <div class="pagination-wrapper">
      <div class="pagination">
        <?php if ($page > 1): ?>
          <a class="page-btn" href="classics.php?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>&filter=<?php echo $filter; ?>"><i class="fas fa-chevron-left"></i></a>
        <?php endif; ?>

        <span class="page-info">Page <?php echo $page; ?> of <?php echo $totalPages; ?></span>

        <?php if ($page < $totalPages): ?>
          <a class="page-btn" href="classics.php?page=<?php echo $page + 1; ?>&search=<?php echo urlencode($search); ?>&filter=<?php echo $filter; ?>"><i class="fas fa-chevron-right"></i></a>
        <?php endif; ?>
      </div>
    </div>
            ...
            .then(data => {
              if (data.status === 'success') {
                ...
                if (confirm('Product added to cart. Do you want to continue shopping? Press OK for Yes, Cancel for No.')) {
                  ...
                  // Cancel => redirect to classics
                  window.location.href = 'classics.php';
                }
              } else {
