<nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo ($page == 'pending_order.php') ? 'active' : ''; ?>" href="pending_order.php">
              <span data-feather="file"></span>
              Pending Orders
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo ($page == 'delivery_boy_order.php') ? 'active' : ''; ?>" href="delivery_boy_order.php">
