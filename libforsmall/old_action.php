...
if (isset($_POST["Common"])) {
    ...
    if (isset($_SESSION["uid"])) {
        ...
        $sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,a.deposit,a.rent_price,
						b.id,b.qty,b.total_duration,b.status ,b.start_date,b.end_date ,b.exchange_price 
...
?>
            <a style="float:right;" href="/libforsmall/cart.php" class="btn btn-warning">Edit&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
<?php
            exit();
        }
    }
    if (isset($_POST["checkOutDetails"])) {
        if (mysqli_num_rows($query) > 0) {
            ...
            echo "<form method='post' action='/libforsmall/login_form'>";
            $n = 0;
            while ($row = mysqli_fetch_array($query)) {
                $n++;
                $product_id = $row["product_id"];
                ...
                if ($status == "purchase") {
                    ...
                    '<div class="row">
								...
								Exchange: <select class="form-control select_user_products"><option value="none">Select Product</option></select><br>
								...
								<input type="hidden" class="form-control selectItemPrice" value="' . $exchange_price . '" readonly="readonly"><br>
                    ...
                    '<div class="row">
								...
								Action: ' . ucfirst($status) . '<br><br>
								Start Date: <input type="date" class="form-control start_date" value=' . $start_date . '><br>
								Return Date: <input type="date" class="form-control end_date" value=' . $end_date . '><br>
								Quantity: <input type="text" class="form-control qty" value="' . $qty . '" ><br>
            ...
            if (!isset($_SESSION["uid"])) {
                ...
                echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="libforsmallt@spacece.co">
                ...
                '<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/libforsmall/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/libforsmall/cancel.php"/>
