$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == "login_success") {
                    ...
                    window.location.href = "libforsmall/cart.php";
                } else {
                    $("#e_msg").html(data);
                    $(".overlay").hide();
                }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data == "register_success") {
                    window.location.href = "libforsmall/index.php";
                } else {
    ...
    /*
          ...
          and send it to /libforsmall/action to perform product removal operation
      */
    ...
    /*
          ...
          and send it to /libforsmall/action to perform product qty updation operation
    ...
    /*
          ...
          First it will enable php isset($_POST["Common"]) in /libforsmall/action page and inside that
    ...
    function net_total() {
        ...
        $(document).on('change', '.end_date', function () {
            ...
            if (statusInfo == "rent") {
                ...
                var qty= $('.qty').val();
                if(total_duration>1){
                   var total = price * $('.qty').val() * total_duration + parseInt(deposit)- (price * $('.qty').val() * 1 + parseInt(deposit));
                row.find(".total").val(total);
              }else{
                 var total = price * $('.qty').val() * total_duration + parseInt(deposit);
                row.find(".total").val(total);
              }
        ...
        $(document).on('change', '.qty', function () {
          ...
          // $(".deposit").val(deposit);
            ...
            if (statusInfo == "rent") {
                ...
                var total = price * $(this).val()* total_duration + parseInt(deposit1)-(price * 1* total_duration + parseInt(deposit));
                row.find(".total").val(total);
            }
            if (statusInfo == "exchange") {
                var total = price * $(this).val() * total_duration - selectItem;
