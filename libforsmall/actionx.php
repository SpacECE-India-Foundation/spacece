            ...
            while ($row = mysqli_fetch_array($query)) {
                ...
                if ($status == "exchange") {
                    ...
                    '<div class="row">
								...
								<div class="col-md-3"><h4>Product Name: ' . $product_title . '</h4>
								Start Date: <input type="date" class="form-control start_date" value=' . $start_date . '><br>
								End Date: <input type="date" class="form-control end_date" value=' . $end_date . '><br>
								Quantity: <input type="text" class="form-control qty" value=' . $qty . ' ><br>
            ...
            if (!isset($_SESSION["uid"])) {
                ...
                echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="libforsmall@spacece.co">
                ...
                '<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										...
										alt="PayPal - The safer, easier way to pay online" id="paypall">
								</form>';
            }
        }
    }
