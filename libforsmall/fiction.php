...
WHERE c.cat_title = 'Fiction' AND p.user_id = ? AND p.product_title LIKE ?";
...
<body class="fiction-page">
  <nav class="nav-bar ">
    <div class="nav-left">
      <a href="index.php">
        <button class="nav-button ">Dashboard</button></a>
      <a href="fiction.php">
        <button class="nav-button active">Fiction</button></a>
  ...
  <main>
    ...
    <div class="pagination-wrapper">
      <div class="pagination">
        <?php if ($page > 1): ?>
          <a class="page-btn" href="fiction.php?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>&filter=<?php echo $filter; ?>"><i class="fas fa-chevron-left"></i></a>
        <?php endif; ?>

        <span class="page-info">Page <?php echo $page; ?> of <?php echo $totalPages; ?></span>

        <?php if ($page < $totalPages): ?>
          <a class="page-btn" href="fiction.php?page=<?php echo $page + 1; ?>&search=<?php echo urlencode($search); ?>&filter=<?php echo $filter; ?>"><i class="fas fa-chevron-right"></i></a>
        <?php endif; ?>
      </div>
    </div>
