   ...
   include("c_connect.php");
    ...
    if (isset($_POST['submit']))
    {
        ...
        $pass = $_POST['psw'];
         ...
         if($cat == "consult"){
        if($_POST['user_type']== "consultant"){
       

        $sql = "SELECT * FROM `user_details` WHERE `user_email`='$name' ";
...
if($cat == "spacetube"){
  ...
  $m = "password or userdetail is incorrect";
  header('Location: c_all_login.php'."?msg=$m");
...
if($cat == "moodle"){
    ...
    if($pass_word == $pass){
       echo "success";
        header('Location: http://educationfoundation.space/moodle/'."?user=$user_name");
     }
else{
  $m = "password or userdetail is incorrect";
  header('Location: c_all_login.php'."?msg=$m");
				...
				<div >
					<div >
						...
						<ul class="main-menu" style="margin-left: 60px;">
							...
							<li><a href="c_index.html" style="color:black"><i class="fa fa-home"></i>HOME</a></li>
...
<form action="c_all_login.php?cat=<?php echo $_SESSION['cat'] ?>" method="post">
